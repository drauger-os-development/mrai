...
int main(int argc, char **argv_list)
{
	...
	try
	{
		...
		if (argv[1].find("-") != std::string::npos)
		{
			...
			{
				if (argv[1].find("a") != std::string::npos or argv[1].find("s") != std::string::npos or argv[1].find("f") != std::string::npos or argv[1].find("g") != std::string::npos)
				{
					if (argv[1].find("a") != std::string::npos)
					{
						L.insert(L.end(),"p");
			...
			elif (L.size() > 0)
			{
				if (argc >= 2)
				{
					if (Vector_Contains(L,"p"))
					{
						...
						if ((argv[1].find("-a") != std::string::npos) or (argv[2].find("-a") != std::string::npos))
						{
							int num;
							if (argv[1].find("-a") != std::string::npos)
							{
							...
							elif (argv[2].find("-a") != std::string::npos)
							{
								num = 3;
							}
