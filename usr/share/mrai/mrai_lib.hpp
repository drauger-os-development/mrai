...
std::vector<string_list> defaults = {
	...
	{"gitautoinst_clone_failure", "git clone failed. Either because the provided URL is not GitHub, or because the cloning is being done as root, or there is no internet."},
